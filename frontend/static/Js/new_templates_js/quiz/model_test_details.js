        ...
        .then(data => {
            if (data) {
               ...
               const title_text = `${data.title}`;
                ...
                document.getElementById('past-exam-negative-marks').textContent = `- ${data.negative_mark}` || 'N/A';
                ...
                document.getElementById('past-exam-duration').textContent = formatDuration(data.duration) || 'N/A';
