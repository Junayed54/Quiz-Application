...
function showBuySubscriptionOnScroll() {
    ...
    function submitExam() {
        ...
        .then(response => response.json())
        .then(data => displayResults(data.correct_answers, data.wrong_answers, data.correct_answers, data.is_passed, data))
    ...
    function displayResults(correctAnswers, wrongAnswers, score, is_passed, data) {
        ...
        modalElement.addEventListener('hidden.bs.modal', function () {
            window.location.href = `/model-tests/${examId}/`;
        });
    }
